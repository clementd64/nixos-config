...
rec {
  ...
  docker_24_0 = callPackage dockerGen rec {
    version = "24.0.4";
    cliRev = "v${version}";
    cliHash = "sha256-1CY7BwN1sJsMn/DJAGgWF1STvAjFn0yXJpgEHJNh6Lw=";
    mobyRev = "v${version}";
    mobyHash = "sha256-gw4gO3ESEIWVbix86stleURsyTm01WyeTQFPC4dtEoU=";
    runcRev = "v1.1.7";
